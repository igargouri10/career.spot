        ...
        <div className="sections">
          <div className="info">
            ...
            <input
              type="text"
              name="title"
              placeholder="Exp: Account Manager"
            ...
            <label htmlFor="">Category</label>
            <select name="subCat" id="subCat" onChange={handleChange}>
            <option value="">Choose your job sub-category</option>
          ...
          <label htmlFor="">Description</label>
            ...
            <input type="text" placeholder="e.g. business-to-business" />
